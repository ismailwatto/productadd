        ...
        <form action="{{ route('order.store') }}" method="POST" id="orderForm">
            ...
            <div class="mb-3">
                <div class="form-check">
                    <input class="form-check-input" name="newUser" type="checkbox" name="newUser" id="newUser">
            ...
            <div id="newUserShow" style="display: none;">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <input type="phone" placeholder="Enter phone" name="phone"><br><br>
                    </div>
                </div>
                <div class="form-group">
                    <div class="row">
                        <label for="email"><b>Email</b></label>
                        <input type="email" placeholder="Enter Email" name="email" autocomplete="username"><br><br>
                    </div>
                </div>
                <div class="mb-4">
                    <div class="row">
            ...
            <div id="itemSection" class="mb-3">
                ...
                <div class="itemItem">
                    <select name="product_name[]" id="item_1">
                        <option disabled selected> Select item</option>
                        @foreach ($items as $item)
                            <option quantity={{ $item->quantity }} price={{ $item->price }}
                                value="{{ $item->id }}">
                                {{ $item->product_name }} </option>
                        @endforeach
                    </select>
                    <label for="quantity_1">Quantity:</label>
                    <input type="number" id="quantity_1" name="quantity[]" min="1" max="" value="1"
                        required>
                    <label for="quantity_1">Total_Quantity:</label>
                    <input type="number" id="total_quantity_1" name="total_quantity[]" min="1" max=""
                        value="1" disabled required>
                    <label for="price_1">Price:</label>
                    <input type="number" id="price_1" name="price[]" min="1" step="1" disabled required>
                    <label for="total_price_1">Total_Price:</label>
                    <input type="text" id="total_price_1" name="total_price[]" readonly>

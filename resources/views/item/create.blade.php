...
<form action="{{ route('item.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <h2 style="text-align: center">Product Form</h2>
        <div class="container">
            ...
            <input type="text" placeholder="Enter product_name" name="product_name" required>

            <label for="quantity"><b>Product_Quantity</b></label>
            <input type="quantity" placeholder="Enter Product_Quantity" name="quantity" autocomplete="username" required>

            <label for="price"><b>Product_Price</b></label>
            <input type="price" placeholder="Enter Product_Price" name="price" required>
